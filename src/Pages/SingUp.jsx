        ...
        <div>
            ...
            <div className="hero min-h-screen bg-base-200 my-20">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    ...
                    <button type="button" className="flex items-center border rounded-md border-[#FDBF05] bg-white px-6 py-2 mb-6 mx-8 text-sm font-medium text-gray-800 hover:bg-gray-200">
